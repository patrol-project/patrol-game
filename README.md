...
Abstract base class with pure virtual functions which serves as a blueprint for all [Game](#class-game) states.
...
[Game](#class-game) object which is a button in the game.
